					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="portlet light ">
							<div class="portlet-title">
								...
								<div class="actions">
									<div class="btn-group">
										 <input type="button" name="options1" class="toggle" id="option1"   value="开始申报" onclick="window.location.href='propose.jsp'">
									</div>
								</div>
							</div>
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="portlet light ">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-share font-red-sunglo hide"></i>
									<span class="caption-subject font-red-sunglo bold uppercase">项目周报</span>
									
									
								</div>
								<div class="actions">
									<div class="btn-group">
										 <input type="button" name="options1" class="toggle" id="option1"   value="开始申报" onclick="window.location.href='weekreport.jsp'">
									</div>
								</div>
							</div>
							<div class="portlet-body">
